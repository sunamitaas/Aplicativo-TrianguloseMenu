...
namespace AppExemplo2.Formularios
{
    public partial class FormAlertas : Form
    {
        ...
        private void btInformacao_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Texto da Mensagem", "Título da Mensagem",
        ...
        private void btErro_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Texto da Mensagem", "Titulo da Mensagem",
        ...
        private void btExemplo_Click(object sender, EventArgs e)
        {
            ...
            resposta =   MessageBox.Show("Gosta de Futebol", "ADS/JIPA",
                MessageBoxButtons.YesNo, MessageBoxIcon.Question);

            MessageBox.Show("Resposta: " + resposta.ToString(), "ADS/JIPA",
                MessageBoxButtons.OK, MessageBoxIcon.Information);

            resposta = MessageBox.Show("Deseja fechar o Programa?", "ADS/JIPA",
                MessageBoxButtons.YesNo, MessageBoxIcon.Question);
